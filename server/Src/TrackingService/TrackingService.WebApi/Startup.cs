...
namespace TrackingService.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(ITrackingService), typeof(TrackingService.Services.TrackingService));
            services.AddScoped(typeof(ITrackingRepository), typeof(TrackingRepository));
            services.AddAutoMapper(typeof(Startup));

            services.AddDbContext<RecordDbContext>
                (options => options
                .UseSqlServer(Configuration.GetConnectionString("weightMonitorTrackingDBConnectionString")));
